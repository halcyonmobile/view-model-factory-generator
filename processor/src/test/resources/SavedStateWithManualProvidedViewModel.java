...
class SavedStateWithManualProvidedViewModel extends ViewModel {
    SavedStateWithManualProvidedViewModel(SavedStateHandle savedStateHandle) {
    }

    SavedStateWithManualProvidedViewModel(@Provided Context context, @Provided SavedStateHandle savedStateHandle, int x) {
    }
